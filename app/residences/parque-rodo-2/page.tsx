      ...
      <main className="pt-16 pb-16 px-4 sm:px-6 lg:px-8">
        <div ref={elementRef} className="max-w-6xl mx-auto text-center mb-10">
          ...
          <div className="mt-2 mb-3 flex items-center justify-center gap-6">
            ...
            <h1 className={`text-3xl sm:text-4xl md:text-5xl font-bold ${isVisible ? 'animate-fade-in-up' : 'opacity-0'}`}>Residencia Parque Rodó II</h1>
        ...
        <GalleryGrid images={images} title="Visor de imágenes - Parque Rodó II" />
      </main>
      <Footer />
    </div>
  )
