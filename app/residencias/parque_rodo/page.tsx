...
const images = [
  { src: "/omgekeerdestemwijzer-banner.png", alt: "Residencia Parque Rodó - fachada" },
  { src: "/HeroVintage.png", alt: "Residencia Parque Rodó - interior" },
  { src: "/LogoVintage.png", alt: "Residencia Parque Rodó - detalle" },
]
    ...
    <div className="min-h-screen bg-background text-foreground">
      ...
      <main className="pt-16 pb-16 px-4 sm:px-6 lg:px-8">
        <div className="max-w-6xl mx-auto text-center mb-10">
          ...
          <h1 className="text-3xl sm:text-4xl md:text-5xl font-bold mt-2 mb-3">Residencia Parque Rodó</h1>
